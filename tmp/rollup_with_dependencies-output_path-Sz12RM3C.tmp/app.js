...
var __ui_components_drake_app_template__ = { "id": "g782OvXr", "block": "{\"symbols\":[],\"statements\":[[5,\"drake-equation\",[],[[\"@starformation\",\"@planetarysystems\",\"@planets\",\"@life\",\"@intelligence\",\"@technology\",\"@time\"],[\"20\",\"50\",\"1\",\"10\",\"50\",\"50\",\"1000\"]],{\"statements\":[],\"parameters\":[]}]],\"hasEval\":false}", "meta": { "specifier": "template:/drake/components/drake-app" } };
...
class DrakeEquation extends Component {
    constructor() {
        super(...arguments);
    ...
    get result() {
        return this.starformation * (this.planetarysystems / 100) * this.planets * (this.life / 100) * (this.intelligence / 100) * (this.technology / 100) * this.time;
    }
