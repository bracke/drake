...
return e&&e[1]?Number(e[1]):null}function U(t){return 1===t.nodeType}function H(t){return 8===t.nodeType&&"%glimmer%"===t.nodeValue}function V(t){return 8===t.nodeType&&"%sep%"===t.nodeValue}function $(t){return 8===t.nodeType&&"%empty%"===t.nodeValue}function z(t){let e=n(t.parentNode,`cannot remove a detached node`),s=t.nextSibling
return e.removeChild(t),s}function G(t,e){for(let s=0;s<t.length;s++){let n=t[s]
if(n.name===e)return n}}function W(){return new Error("Not implemented")}function J(t){return function(e){return Array.isArray(e)&&e[0]===t}}function Y(t,e){let s=new tn(e)
return t.compile(s),s.compile()}function X(t,e){return new cn(t,e)}function q(t){return"object"==typeof t&&null!==t&&"function"==typeof t.compile}function K(t,e,s){let n=t[1],i=t[2],r=t[3]
...
return"attr"===i?_t(s,r):wt(s,r)}function _t(t,e){return at(t,e)?Kn:Yn}function wt(t,e){return at(t,e)?qn:Ct(t,e)?Qn:Et(t,e)?Zn:Xn}function Et(t,e){return"OPTION"===t&&"selected"===e}function Ct(t,e){return("INPUT"===t||"TEXTAREA"===t)&&"value"===e}function xt(t){return!1===t||void 0===t||null===t||void 0===t.toString?null:!0===t?"":"function"==typeof t?null:String(t)}function Nt({id:t,meta:e,block:s}){let n,i=t||`client-${yi++}`
...
return Vt(t)&&(s="/"+s),s}}function Gt(t){let e={}
...
return e}function Wt(t,e){if(!e)throw new Error("Assertion Failed: "+t)}function Jt(...t){let e=t[0],s=t[1],n=t[2]
return"string"==typeof e?function(e,s,n){return Yt(e,s,n,t)}:n?Yt(e,s,n,[]):void Xt(e,s)}function Yt(t,e,s,n){let i=Kt(t)
return i.trackedProperties[e]=!0,i.trackedPropertyDependencies[e]=n||[],{enumerable:!0,configurable:!1,get:s.get,set:function(){Kt(this).dirtyableTagFor(e).inner.dirty(),s.set.apply(this,arguments),qi()}}}function Xt(t,e){let s,n=Symbol(e)
Kt(t).trackedProperties[e]=!0,void 0!==t[e]&&(s=t[e]),Object.defineProperty(t,e,{configurable:!0,get(){return this[n]},set(t){Kt(this).dirtyableTagFor(e).inner.dirty(),this[n]=t,qi()}})}function qt(t,e,s){let n=[t.dirtyableTagFor(e)]
if(s&&s.length)for(let e=0;e<s.length;e++)n.push(t.tagFor(s[e]))
return b(n)}function Kt(t){let e=t[Yi]
return e&&Qt(t,Yi)?e:t[Yi]=new Ji(e)}function Qt(t,e){return Xi.call(t,e)}function Zt(t,e){throw Ki.for(t,e)}function te(t,e,s=Zt){return"object"==typeof t&&t?Kt(t).tagFor(e):Oe}function ee(t,e){let s=`The '${e}' property on the ${t} was changed after it had been rendered. Properties that change after being rendered must be tracked. Use the @tracked decorator to mark this as a tracked property.`
throw new Ki(t,e,s)}class se{constructor(t,e=null){this._registry=t,this._resolver=e,this._lookups={},this._factoryDefinitionLookups={}}factoryFor(t){let e=this._factoryDefinitionLookups[t]
...
class Ee{constructor(){h(this)}toJSON(){return{guid:this._guid,type:this.type}}}class Ce extends Ee{constructor(){super(...arguments),this.next=null,this.prev=null}}const xe=1
...
class Pe extends Re{static create(t){return new De(this.id,new Pe(t))}constructor(t){super(),this.tag=t,this.lastUpdated=xe}compute(){return Math.max(this.lastUpdated,this.tag.value())}update(t){t!==this.tag&&(this.tag=t,this.lastUpdated=Me,this.invalidate())}}d(Pe)
...
t.retained=!0,s.remove(t),s.insertBefore(t,e)}remove(t){this.list.remove(t),delete this.map[t.key]}nextNode(t){return this.list.nextNode(t)}head(){return this.list.head()}}class We{constructor(t){this.iterator=null
let e=new Ge(t)
this.artifacts=e}next(){let t=this.artifacts,e=(this.iterator=this.iterator||t.iterate()).next()
return e?t.append(e):null}}var Je;(function(t){t[t.Append=0]="Append",t[t.Prune=1]="Prune",t[t.Done=2]="Done"})(Je||(Je={}))
class Ye{constructor({target:t,artifacts:e}){this.target=t,this.artifacts=e,this.iterator=e.iterate(),this.current=e.head()}sync(){let t=Je.Append
for(;;)switch(t){case Je.Append:t=this.nextAppend()
break
case Je.Prune:t=this.nextPrune()
break
case Je.Done:return void this.nextDone()}}advanceToKey(t){let e=this.current,s=this.artifacts,n=e
...
s.insert(i.key,i.value,i.memo,n?n.key:null)}startPrune(){return this.current=this.artifacts.head(),Je.Prune}nextPrune(){let t=this.artifacts,e=this.target,s=this.current
if(null===s)return Je.Done
let n=s
return this.current=t.nextNode(n),n.shouldRemove()?(t.remove(n),e.delete(n.key)):n.reset(),Je.Prune}nextDone(){this.target.done()}}class Xe extends $e{constructor(t){super(t)}static create(t){return void 0===t?Qe:null===t?Ze:!0===t?ts:!1===t?es:"number"==typeof t?new Ke(t):new qe(t)}get(t){return Qe}}class qe extends Xe{constructor(){super(...arguments),this.lengthReference=null}get(t){if("length"===t){let t=this.lengthReference
return null===t&&(t=this.lengthReference=new Ke(this.inner.length)),t}return super.get(t)}}class Ke extends Xe{constructor(t){super(t)}}const Qe=new Ke(void 0),Ze=new Ke(null),ts=new Ke(!0),es=new Ke(!1)
...
class us extends Ce{constructor(t,e,s){super(),this.tag=t,this.manager=e,this.modifier=s,this.type="update-modifier",this.lastUpdated=t.value()}evaluate(t){let e=this.manager,s=this.modifier,n=this.tag,i=this.lastUpdated
...
class ps extends Ce{constructor(t,e){super(),this.reference=t,this.attribute=e,this.type="patch-element",this.tag=t.tag}evaluate(t){let e=this.attribute,s=this.reference
...
s.push(n),l.push(r)}s.push(l),a.setup(s,!1)}s.push(a)}),we.add(60,(t,{op1:e,op2:s})=>{var n
...
class Ss extends Ce{constructor(t,e,s,n,i){super(),this.tag=t,this.name=e,this.component=s,this.manager=n,this.dynamicScope=i,this.type="update-component"}evaluate(t){let e=this.component,s=this.manager,n=this.dynamicScope
s.update(e,n)}toJSON(){return{args:[JSON.stringify(this.name)],guid:this._guid,type:this.type}}}class _s extends Ce{constructor(t,e,s){super(),this.manager=t,this.component=e,this.bounds=s,this.type="did-update-layout",this.tag=Oe}evaluate(t){let e=this.manager,s=this.component,n=this.bounds
e.didUpdateLayout(s,n),t.env.didUpdate(s,e)}}const ws="COMPONENT DEFINITION [id=e59c754e-61eb-4392-8c4a-2c0ac72bfcd4]"
class Es{constructor(t,e,s){this[ws]=!0,this.name=t,this.manager=e,this.ComponentClass=s}}class Cs extends ss{static create(t){return new Cs(t)}toBool(t){return D(t)}}we.add(26,(t,{op1:e})=>{let s,n=t.stack.pop(),i=n.value()
s=e?t.elements().appendTrustingDynamicContent(i):t.elements().appendCautiousDynamicContent(i),m(n)||t.updateWith(new xs(n,s))})
class xs extends Ce{constructor(t,e){super(),this.reference=t,this.content=e,this.tag=t.tag}evaluate(t){let e=this.content,s=this.reference
...
class As{constructor(t){this.tag=t.tag,this.artifacts=t}value(){return!this.artifacts.isEmpty()}}we.add(54,t=>{let e=t.stack,s=e.pop(),n=e.pop(),i=t.env.iterableFor(s,n.value()),r=new We(i)
...
let n
return(n=C(e)?"":A(e)?e:String(e))!==s&&(this.bounds.firstNode().nodeValue=this.lastValue=n),this}}class Fs extends Ms{constructor(t,e,s){super(s),this.bounds=t,this.lastValue=e}update(t,e){return e===this.lastValue?this:this.retry(t,e)}}class Is extends Ms{constructor(t,e,s){super(s),this.bounds=t,this.lastValue=e}update(t,e){let s=this.lastValue
return e===s?this:x(e)&&e.toHTML()===s.toHTML()?(this.lastValue=e,this):this.retry(t,e)}}class Ps extends Ms{constructor(t,e,s){super(s),this.bounds=t,this.lastValue=e}update(t,e){let s=this.lastValue
...
return new Fs(M(this.element,e),e,!1)}if(x(t)){let e=t.toHTML(),s=this.__appendHTML(e)
...
return r.set(this,e,this.env),r}}class Vs{constructor(t){this.parent=t,this.first=null,this.last=null,this.destroyables=null,this.nesting=0}destroy(){let t=this.destroyables
if(t&&t.length)for(let e=0;e<t.length;e++)t[e].destroy()}parentElement(){return this.parent}firstNode(){return this.first&&this.first.firstNode()}lastNode(){return this.last&&this.last.lastNode()}openElement(t){this.didAppendNode(t),this.nesting++}closeElement(){this.nesting--}didAppendNode(t){0===this.nesting&&(this.first||(this.first=new js(t)),this.last=new Us(t))}didAppendBounds(t){0===this.nesting&&(this.first||(this.first=t),this.last=t)}newDestroyable(t){this.destroyables=this.destroyables||[],this.destroyables.push(t)}finalize(t){this.first||t.appendComment("")}}class $s extends Vs{destroy(){super.destroy(),R(this)}}class zs extends Vs{reset(t){let e=this.destroyables
...
t&&this.clearMismatch(t),this._candidate=this.element.nextSibling,this.lastMatchedNode=this.element,super.willCloseElement()}pushRemoteElement(t,e=null){throw W()}popRemoteElement(){throw W()}didAppendBounds(t){super.didAppendBounds(t)
let e=t.lastNode()
return this._candidate=e&&e.nextSibling,t}didOpenElement(t){return super.didOpenElement(t),this._candidate=t.firstChild,t}}class Js extends Hs{constructor(){super(...arguments),this.serializeBlockDepth=0}__openBlock(){let t=this.serializeBlockDepth++
...
var Xs;(function(t){t.isUnknown=J(Ys.Unknown),t.isGet=J(Ys.Get),t.isConcat=J(Ys.Concat),t.isHelper=J(Ys.Helper),t.isHasBlock=J(Ys.HasBlock),t.isHasBlockParams=J(Ys.HasBlockParams),t.isUndefined=J(Ys.Undefined),t.isClientSide=J(Ys.ClientSideExpression),t.isMaybeLocal=J(Ys.MaybeLocal),t.isPrimitiveValue=function(t){return null===t||"object"!=typeof t}})(Xs||(Xs={}))
var qs;(function(t){function e(t){return t[0]===Ys.StaticAttr||t[0]===Ys.DynamicAttr||t[0]===Ys.TrustingAttr}function s(t){return t[0]===Ys.StaticArg||t[0]===Ys.DynamicArg}t.isText=J(Ys.Text),t.isAppend=J(Ys.Append),t.isComment=J(Ys.Comment),t.isModifier=J(Ys.Modifier),t.isBlock=J(Ys.Block),t.isComponent=J(Ys.Component),t.isOpenElement=J(Ys.OpenElement),t.isFlushElement=J(Ys.FlushElement),t.isCloseElement=J(Ys.CloseElement),t.isStaticAttr=J(Ys.StaticAttr),t.isDynamicAttr=J(Ys.DynamicAttr),t.isYield=J(Ys.Yield),t.isPartial=J(Ys.Partial),t.isDynamicArg=J(Ys.DynamicArg),t.isStaticArg=J(Ys.StaticArg),t.isTrustingAttr=J(Ys.TrustingAttr),t.isDebugger=J(Ys.Debugger),t.isClientSide=J(Ys.ClientSideStatement),t.isAttribute=e,t.isArgument=s,t.isParameter=function(t){return e(t)||s(t)},t.getParameterName=function(t){return t[1]}})(qs||(qs={}))
var Ks;(function(t){t[t.OpenComponentElement=0]="OpenComponentElement",t[t.DidCreateElement=1]="DidCreateElement",t[t.SetComponentAttrs=2]="SetComponentAttrs",t[t.DidRenderLayout=3]="DidRenderLayout",t[t.FunctionExpression=4]="FunctionExpression",t[t.Debugger=5]="Debugger"})(Ks||(Ks={}))
...
return this.layout.asLayout(this.componentName,this.attrs.buffer).compileDynamic(t)}}class nn{constructor(){this.isDynamic=null,this.isStatic=null,this.staticTagName=null,this.dynamicTagName=null}getDynamic(){if(this.isDynamic)return this.dynamicTagName}getStatic(){if(this.isStatic)return this.staticTagName}static(t){this.isStatic=!0,this.staticTagName=t}dynamic(t){this.isDynamic=!0,this.dynamicTagName=[Ys.ClientSideExpression,Ks.FunctionExpression,t]}}class rn{constructor(){this.buffer=[]}static(t,e){this.buffer.push([Ys.StaticAttr,t,e,null])}dynamic(t,e){this.buffer.push([Ys.DynamicAttr,t,[Ys.ClientSideExpression,Ks.FunctionExpression,e],null])}}class an{constructor(t){this.builder=t,this.env=t.env}static(t,e){let s=e[0],n=e[1],i=e[2],r=e[3],a=this.builder
...
if(e){i=e[0]
let t=e[1]
for(let e=0;e<t.length;e++)Q(t[e],this)}this.pushImmediate(i),this.pushArgs(s)}compile(t){return q(t)?t.compile(this):t}guardedAppend(t,e){this.startLabels(),this.pushFrame(),this.returnTo("END"),Q(t,this),this.dup(),this.test(t=>Cs.create(t)),this.enter(2),this.jumpUnless("ELSE"),this.pushDynamicComponentManager(),this.invokeComponent(null,null,null,null,null),this.exit(),this.return(),this.label("ELSE"),this.dynamicContent(e),this.exit(),this.return(),this.label("END"),this.popFrame(),this.stopLabels()}invokeComponent(t,e,s,n,i=null){this.fetch(Se.s0),this.dup(Se.sp,1),this.load(Se.s0),this.pushBlock(n),this.pushBlock(i),this.compileArgs(e,s,!1),this.prepareArgs(Se.s0),this.beginComponentTransaction(),this.pushDynamicScope(),this.createComponent(Se.s0,null!==n,null!==i),this.registerComponentDestructor(Se.s0),this.getComponentSelf(Se.s0),this.getComponentLayout(Se.s0),this.invokeDynamic(new gn(t&&t.scan())),this.popFrame(),this.popScope(),this.popDynamicScope(),this.commitComponentTransaction(),this.load(Se.s0)}template(t){return t?new on(this.meta,t.statements,t.parameters):null}}var un=Ys
const pn="&attrs"
...
a(!!i,`expected an implementation for ${0===this.offset?un[t[0]]:Ks[t[1]]}`),i(t,e)}}const mn=new dn,fn=new dn(1)
...
e.staticAttr(s,i,n)}),mn.add(un.DynamicAttr,(t,e)=>{K(t,!1,e)}),mn.add(un.TrustingAttr,(t,e)=>{K(t,!0,e)}),mn.add(un.OpenElement,(t,e)=>{e.openPrimitiveElement(t[1])}),fn.add(Ks.OpenComponentElement,(t,e)=>{e.putComponentOperations(),e.openElementWithOperations(t[2])}),fn.add(Ks.DidCreateElement,(t,e)=>{e.didCreateElement(Se.s0)}),fn.add(Ks.SetComponentAttrs,(t,e)=>{e.setComponentAttrs(t[2])}),fn.add(Ks.Debugger,()=>{}),fn.add(Ks.DidRenderLayout,(t,e)=>{e.didRenderLayout(Se.s0)}),mn.add(un.Append,(t,e)=>{let s=t[1],n=t[2]
...
if(e.env.hasComponentDefinition(s,e.meta.templateMeta)){let t=e.template(r),a=[[un.ClientSideStatement,Ks.SetComponentAttrs,!0],...n,[un.ClientSideStatement,Ks.SetComponentAttrs,!1]],o=new on(e.meta,a,ke),l=e.env.getComponentDefinition(s,e.meta.templateMeta)
...
void 0!==s&&a.bind(e,s)}a.bindPartialMap(h),t.pushFrame(),t.call(n.handle)}}mn.add(un.Partial,(t,e)=>{let s=t[1],n=t[2]
var i=e.meta
...
e.concat(s.length)}),kn.add(Ks.FunctionExpression,(t,e)=>{e.function(t[2])}),vn.add(un.Helper,(t,e)=>{let s=e.env,n=e.meta,i=t[1],r=t[2],a=t[3]
...
e.getVariable(s)
for(let t=0;t<n.length;t++)e.getProperty(n[t])}),vn.add(un.MaybeLocal,(t,e)=>{let s=t[1]
if(e.meta.asPartial){let t=s[0]
s=s.slice(1),e.resolveMaybeLocal(t)}else e.getVariable(0)
for(let t=0;t<s.length;t++)e.getProperty(s[t])}),vn.add(un.Undefined,(t,e)=>e.primitive(void 0)),vn.add(un.HasBlock,(t,e)=>{e.hasBlock(t[1])}),vn.add(un.HasBlockParams,(t,e)=>{e.hasBlockParams(t[1])}),vn.add(un.ClientSideExpression,(t,e)=>{kn.compile(t,e)})
...
e=new Zs(s.handle,this.symbolTable)}return e}}var Cn=Ys
class xn{constructor(t,e){this.block=t,this.env=e}scanEntryPoint(t){let e=this.block,s=e.statements,n=e.symbols,i=e.hasEval
...
return e.push([Cn.ClientSideStatement,Ks.DidRenderLayout]),e}processStatement(t,e){switch(this.state){case 0:this.processBeforeTopLevel(t,e)
break
case 1:this.processInTopLevel(t,e)
break
case 2:e.push(t)
break
default:throw i()}}processBeforeTopLevel(t,e){qs.isComponent(t)?this.processTopLevelComponent(t,e):qs.isOpenElement(t)?this.processIsOpenElement(t,e):e.push(t)}processTopLevelComponent(t,e){let s=t[1],n=t[2],i=t[4]
if(this.env.hasComponentDefinition(s,this.meta)&&s!==this.componentName)return e.push(t),void(this.state=2)
a(!this.env.hasComponentDefinition(s,this.meta)||s===this.componentName,`Cannot use a component (<${s}>) as the top-level element in the layout of <${this.componentName}>`),this.state=1,e.push([Cn.ClientSideStatement,Ks.SetComponentAttrs,!0]),e.push([Cn.ClientSideStatement,Ks.OpenComponentElement,s]),e.push([Cn.ClientSideStatement,Ks.DidCreateElement])
for(let t=0;t<n.length;t++)this.processStatement(n[t],e)
if(this.processStatement([Cn.FlushElement],e),i){let t=i.statements
for(let s=0;s<t.length;s++)this.processStatement(t[s],e)}this.processStatement([Cn.CloseElement],e)}processIsOpenElement(t,e){let s=t[1]
this.state=1,e.push([Cn.ClientSideStatement,Ks.SetComponentAttrs,!0]),e.push([Cn.ClientSideStatement,Ks.OpenComponentElement,s]),e.push([Cn.ClientSideStatement,Ks.DidCreateElement])}processInTopLevel(t,e){if(a(!qs.isModifier(t),`Cannot use element modifiers ({{${t[1]} ...}}) in the top-level element in the layout of <${this.componentName}>`),qs.isFlushElement(t)){let t=this.symbols,s=this.attrs
this.state=2
let n=t.push(pn)
e.push(...s),e.push([Cn.Yield,n,ke]),e.push([Cn.ClientSideStatement,Ks.SetComponentAttrs,!1])}e.push(t)}}class Tn{constructor(){this.references=[],this.strings=[],this.expressions=[],this.arrays=[],this.blocks=[],this.functions=[],this.others=[]}getReference(t){return this.references[t-1]}reference(t){let e=this.references.length
...
return this.document.createElementNS(In,t)}return this.document.createElement(t)}insertBefore(t,e,s){t.insertBefore(e,s)}insertHTMLBefore(t,e,s){return vt(this.uselessElement,t,e,s)}createTextNode(t){return this.document.createTextNode(t)}createComment(t){return this.document.createComment(t)}}var Vn;(function(t){class e extends Hn{createElementNS(t,e){return this.document.createElementNS(t,e)}setAttribute(t,e,s,n=null){n?t.setAttributeNS(n,e,s):t.setAttribute(e,s)}}t.TreeConstruction=e
let s=e
s=gt(Un,s),s=ct(Un,s),s=dt(Un,s,In),t.DOMTreeConstruction=s})(Vn||(Vn={}))
class $n extends Hn{constructor(t){super(t),this.document=t,this.namespace=null}setAttribute(t,e,s){t.setAttribute(e,s)}setAttributeNS(t,e,s,n){t.setAttributeNS(e,s,n)}removeAttribute(t,e){t.removeAttribute(e)}removeAttributeNS(t,e,s){t.removeAttributeNS(e,s)}insertNodeBefore(t,e,s){if(kt(e)){let n=e.firstChild,i=e.lastChild
...
return this.insertBefore(t,n,e),n}insertBefore(t,e,s){t.insertBefore(e,s)}insertAfter(t,e,s){this.insertBefore(t,e,s.nextSibling)}}let zn=$n
...
const Wn=Vn.DOMTreeConstruction
class Jn{constructor(t){this.attribute=t}}class Yn extends Jn{set(t,e,s){let n=xt(e)
...
null===s?i.removeAttribute(r):i.setAttribute(r,s)}}class Xn extends Jn{set(t,e,s){if(null!==e&&void 0!==e){let s=this.attribute.name
...
n?e.removeAttributeNS(n,s):e.removeAttribute(s)}}class qn extends Xn{set(t,e,s){var n=this.attribute
let i=ot(s,n.element,n.name,e)
super.set(t,i,s)}update(t,e){var s=this.attribute
let n=ot(e,s.element,s.name,t)
super.update(n,e)}}class Kn extends Yn{set(t,e,s){var n=this.attribute
let i=ot(s,n.element,n.name,e)
super.set(t,i,s)}update(t,e){var s=this.attribute
let n=ot(e,s.element,s.name,t)
...
e.update(s)}}}class si{constructor(t){this.heap=t,this.offset=0}get type(){return this.heap.getbyaddr(this.offset)}get op1(){return this.heap.getbyaddr(this.offset+1)}get op2(){return this.heap.getbyaddr(this.offset+2)}get op3(){return this.heap.getbyaddr(this.offset+3)}}var ni;(function(t){t[t.Allocated=0]="Allocated",t[t.Freed=1]="Freed",t[t.Purged=2]="Purged",t[t.Pointer=3]="Pointer"})(ni||(ni={}))
...
s.didDestroy(),R(s),this.updating.remove(s),delete e[t],this.didDelete=!0}done(){this.opcode.didInitializeChildren(this.didInsert||this.didDelete)}}class ui extends li{constructor(t,e,s,n,i){super(t,e,s,n),this.type="list-block",this.map=p(),this.lastIterated=xe,this.artifacts=i
...
class bi{constructor(t,e,s,n){this.id=t,this.meta=e,this.env=s,this.entryPoint=null,this.layout=null,this.partial=null,this.block=null,this.scanner=new xn(n,s),this.symbols=n.symbols,this.hasEval=n.hasEval}render({self:t,parentNode:e,dynamicScope:s,mode:n}){let i,r=this.env
switch(n){case void 0:i=Hs.forInitialRender(r,e,null)
break
case"rehydrate":i=Ws.forInitialRender(r,e,null)
break
case"serialize":i=Js.forInitialRender(r,e,null)
break
...
class _i{constructor(t,e){this.tag=Be,this.parent=t}chain(){return Si}notify(){}value(){return this.parent[this.property]}get(t){return new _i(this.parent[this.property],t)}}class wi{constructor(t){this.tag=Be,this.inner=t}update(t){this.inner=t}chain(){return Si}notify(){}value(){return this.inner}referenceFromParts(t){throw new Error("Not implemented")}chainFor(t){throw new Error("Not implemented")}get(t){return new _i(this.inner,t)}}class Ei{constructor(t){this.object=t}root(){return new wi(this.object)}}const Ci="df8be4c8-4e89-44e2-a8f9-550c8dacdca7",xi=Object.hasOwnProperty
...
return"function"!=typeof i&&Lt(i,n.positional.at(0)),new $e(function(...t){let e=n.positional.value()
e.shift(),e.push(...t),i.apply(s&&s.value(),e)})}}
class Vi extends ai{constructor(s){super({appendOperations:s.appendOperations,updateOperations:new Gn(s.document||document)}),this.helpers=p(),this.modifiers=p(),this.components=p(),this.managers=p(),e(this,t(s)),this.uselessAnchor=s.document.createElement("a")}static create(t={}){return t.document=t.document||self.document,t.appendOperations=t.appendOperations||new Wn(t.document),new Vi(t)}protocolForURL(t){return this.uselessAnchor.href=t,this.uselessAnchor.protocol}hasPartial(){return!1}lookupPartial(){}managerFor(e=Ui){let s
...
return a}}var $i={id:"UN61+JFU",block:'{"symbols":["root"],"statements":[[4,"each",[[19,0,["roots"]]],[["key"],["id"]],{"statements":[[4,"-in-element",[[19,1,["parent"]]],[["nextSibling"],[[19,1,["nextSibling"]]]],{"statements":[[1,[25,"component",[[19,1,["component"]]],null],false]],"parameters":[]},null]],"parameters":[1]},null]],"hasEval":false}',meta:{specifier:"template:/-application/templates/main"}}
...
t.register(`environment:/${this.rootName}/main/main`,Vi),t.registerOption("helper","instantiate",!1),t.registerOption("template","instantiate",!1),t.register(`document:/${this.rootName}/main/main`,this.document),t.registerOption("document","instantiate",!1),t.registerInjection("environment","document",`document:/${this.rootName}/main/main`),t.registerInjection("component-manager","env",`environment:/${this.rootName}/main/main`)
...
let t,e=Nt($i).create(this.env),s=new ki({roots:this._roots}),n=this.document.body,i=new Di,r=e.render({self:s,parentNode:n,dynamicScope:i})
...
return Wt(`'${t}' is not a recognized type`,e),e.definitiveCollection}_serializeAndVerify(t){let e=$t(t)
if(this.registry.has(e))return e}}class Wi{constructor(t={}){this._entries=t}has(t){return t in this._entries}get(t){return this._entries[t]}}class Ji{constructor(t){this.tags=p(),this.computedPropertyTags=p(),this.trackedProperties=t?Object.create(t.trackedProperties):p(),this.trackedPropertyDependencies=t?Object.create(t.trackedPropertyDependencies):p()}tagFor(t){let e=this.tags[t]
if(e)return e
let s
return(s=this.trackedPropertyDependencies[t])?this.tags[t]=qt(this,t,s):this.tags[t]=Le.create()}dirtyableTagFor(t){let e
return this.trackedPropertyDependencies[t]?(e=this.computedPropertyTags[t])||(this.computedPropertyTags[t]=Le.create()):(e=this.tags[t])||(this.tags[t]=Le.create())}}let Yi=Symbol("ember-object"),Xi=Object.prototype.hasOwnProperty,qi=function(){}
class Ki extends Error{constructor(t,e,s){super(s),this.target=t,this.key=e}static for(t,e){return new Ki(t,e,`The property '${e}' on ${t} was changed after being rendered. If you want to change a property used in a template after the component has rendered, mark the property as a tracked property with the @tracked decorator.`)}}class Qi{constructor(t){this.element=null,this.debugName=null,this.__args__=null,Object.assign(this,t)}get args(){return this.__args__}set args(t){this.__args__=t,Kt(this).dirtyableTagFor("args").inner.dirty()}static create(t){return new this(t)}didInsertElement(){}didUpdate(){}willDestroy(){}destroy(){this.willDestroy()}toString(){return`${this.debugName} component`}}class Zi extends Es{constructor(t,e,s,n){super(t,e,n),this.template=s,this.componentFactory=n}toJSON(){return{GlimmerDebug:`<component-definition name="${this.name}">`}}}class tr{get(t){return nr.create(this,t)}}class er extends tr{constructor(){super(...arguments),this._lastRevision=null,this._lastValue=null}value(){let t=this.tag,e=this._lastRevision,s=this._lastValue
return e&&t.validate(e)||(s=this._lastValue=this.compute(),this._lastRevision=t.value()),s}}class sr extends $e{constructor(){super(...arguments),this.children=p()}get(t){let e=this.children[t]
...
class cr extends Qi{constructor(){super(...arguments),this.starformation=this.args.starformation||10,this.planetarysystems=this.args.planetarysystems||50,this.planets=this.args.planets||1,this.life=this.args.life||10,this.intelligence=this.args.intelligence||50,this.technology=this.args.technology||50,this.time=this.args.time||1e3}get result(){return this.starformation*(this.planetarysystems/100)*this.planets*(this.life/100)*(this.intelligence/100)*(this.technology/100)*this.time}updateStarformation(t){this.starformation=t.target.value}updatePlanetarysystems(t){this.planetarysystems=t.target.value}updatePlanets(t){this.planets=t.target.value}updateLife(t){this.life=t.target.value}updateIntelligence(t){this.intelligence=t.target.value}updateTechnology(t){this.technology=t.target.value}updateTime(t){this.time=t.target.value}}hr([Jt],cr.prototype,"starformation",void 0),hr([Jt],cr.prototype,"planetarysystems",void 0),hr([Jt],cr.prototype,"planets",void 0),hr([Jt],cr.prototype,"life",void 0),hr([Jt],cr.prototype,"intelligence",void 0),hr([Jt],cr.prototype,"technology",void 0),hr([Jt],cr.prototype,"time",void 0),hr([Jt("starformation","planetarysystems","planets","life","intelligence","technology","time")],cr.prototype,"result",null)
var ur={"component:/drake/components/drake-equation":cr,"template:/drake/components/drake-equation":{id:"zh6NQhKc",block:'{"symbols":[],"statements":[[6,"div"],[7],[0,"\\n"],[6,"div"],[9,"class","header"],[7],[6,"h3"],[7],[0,"The number of civilizations in the Milky Way Galaxy whose electromagnetic emissions are detectable."],[8],[0,"\\n"],[6,"span"],[7],[0,"Estimated using "],[6,"a"],[9,"href","https://en.wikipedia.org/wiki/Drake_equation"],[9,"target","_blank"],[7],[0,"Drake equation"],[8],[0,"."],[8],[0,"\\n"],[8],[0,"\\n"],[6,"h1"],[9,"class","result"],[7],[1,[18,"result"],false],[8],[0,"\\n"],[6,"table"],[7],[0,"\\n\\t"],[6,"tr"],[7],[6,"td"],[7],[6,"div"],[9,"class","variablefield"],[7],[6,"input"],[9,"type","number"],[9,"min","1"],[10,"value",[18,"starformation"],null],[10,"onchange",[25,"action",[[19,0,["updateStarformation"]]],null],null],[7],[8],[8],[8],[6,"td"],[7],[6,"div"],[9,"class","variableDescription"],[7],[0,"The rate of formation of stars suitable for the development of intelligent life."],[8],[8],[8],[0,"\\n\\n\\t"],[6,"tr"],[7],[6,"td"],[7],[6,"div"],[9,"class","variablefield"],[7],[6,"input"],[9,"type","range"],[10,"value",[18,"planetarysystems"],null],[10,"onchange",[25,"action",[[19,0,["updatePlanetarysystems"]]],null],null],[9,"min","1"],[9,"max","100"],[9,"step","1"],[7],[8],[8],[8],[6,"td"],[7],[6,"div"],[9,"class","variableDescription"],[7],[0,"The fraction of those stars with planetary systems."],[8],[8],[8],[0,"\\n\\t"],[6,"tr"],[7],[6,"td"],[7],[6,"div"],[9,"class","variablefield"],[7],[6,"input"],[9,"type","number"],[9,"min","0"],[10,"value",[18,"planets"],null],[10,"onchange",[25,"action",[[19,0,["updatePlanets"]]],null],null],[7],[8],[8],[8],[6,"td"],[7],[6,"div"],[9,"class","variableDescription"],[7],[0,"The number of planets, per solar system, with an environment suitable for life."],[8],[8],[8],[0,"\\n\\n\\t"],[6,"tr"],[7],[6,"td"],[7],[6,"div"],[9,"class","variablefield"],[7],[6,"input"],[9,"type","range"],[10,"value",[18,"life"],null],[10,"onchange",[25,"action",[[19,0,["updateLife"]]],null],null],[9,"min","1"],[9,"max","100"],[9,"step","1"],[7],[8],[8],[8],[6,"td"],[7],[6,"div"],[9,"class","variableDescription"],[7],[0,"The fraction of suitable planets on which life actually appears."],[8],[8],[8],[0,"\\n\\n\\t"],[6,"tr"],[7],[6,"td"],[7],[6,"div"],[9,"class","variablefield"],[7],[6,"input"],[9,"type","range"],[10,"value",[18,"intelligence"],null],[10,"onchange",[25,"action",[[19,0,["updateIntelligence"]]],null],null],[9,"min","1"],[9,"max","100"],[9,"step","1"],[7],[8],[8],[8],[6,"td"],[7],[6,"div"],[9,"class","variableDescription"],[7],[0,"The fraction of life bearing planets on which intelligent life emerges."],[8],[8],[8],[0,"\\n\\t"],[6,"tr"],[7],[6,"td"],[7],[6,"div"],[9,"class","variablefield"],[7],[6,"input"],[9,"type","range"],[10,"value",[18,"technology"],null],[10,"onchange",[25,"action",[[19,0,["updateTechnology"]]],null],null],[9,"min","1"],[9,"max","100"],[9,"step","1"],[7],[8],[8],[8],[6,"td"],[7],[6,"div"],[9,"class","variableDescription"],[7],[0,"The fraction of civilizations that develop a technology that releases detectable signs of their existence into space."],[8],[8],[8],[0,"\\n\\t"],[6,"tr"],[7],[6,"td"],[7],[6,"div"],[9,"class","variablefield"],[7],[6,"input"],[9,"placeholder","years"],[9,"type","number"],[9,"min","1"],[10,"value",[18,"time"],null],[10,"onchange",[25,"action",[[19,0,["updateTime"]]],null],null],[7],[8],[8],[8],[6,"td"],[7],[6,"div"],[9,"class","variableDescription"],[7],[0,"The length of time (years) such civilizations release detectable signals into space."],[8],[8],[8],[0,"\\n\\n"],[8],[0,"\\n"],[8]],"hasEval":false}',meta:{specifier:"template:/drake/components/drake-equation"}}},pr={app:{name:"drake",rootName:"drake"},types:{application:{definitiveCollection:"main"},component:{definitiveCollection:"components"},"component-test":{unresolvable:!0},helper:{definitiveCollection:"components"},"helper-test":{unresolvable:!0},renderer:{definitiveCollection:"main"},template:{definitiveCollection:"components"}},collections:{main:{types:["application","renderer"]},components:{group:"ui",types:["component","component-test","template","helper","helper-test"],defaultType:"component",privateCollections:["utils"]},styles:{group:"ui",unresolvable:!0},utils:{unresolvable:!0}}}
class dr extends zi{constructor(){let t=new Wi(ur),e=new Gi(pr,t)
super({rootName:pr.app.rootName,resolver:e})}}const mr=new dr,fr=document.getElementById("app");(function(t){qi=t})(()=>{mr.scheduleRerender()}),mr.registerInitializer({initialize(t){t.register(`component-manager:/${mr.rootName}/component-managers/main`,lr)}}),mr.renderComponent("drake-equation",fr,null),mr.boot()})
